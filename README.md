...
- JavaScript vs TypeScript
       ...
       ❓ 도입이유     
        ...
        - 타입스크립트의 이해도가 낮은 상태에서 사용하면 자바스크립트를 사용하는 것과 큰 차이가 없음
...
- DB, ORM
       ❓ 도입이유 
        ...
        - 이미 MySQL 로 개발이 상당 부분 진행된 상태였고, 배열을 데이터로 삽입하기 이유 하나로 DB를 변경하는 개발 코스트를 감당하기 힘듦
...
- CI/CD
       ❓ 도입이유 
        ...
        - jenkins 는 환경 호환성을 위해 docker 에서 사용해야 하지만 현 프로젝트는 docker 를 사용하지 않음
        
        📌 의견 결정
        - 백엔드 개발자의 환경이 windows 와 mac os 로 다르기 때문에 환경 호환성이 좋고,  github action으로 결정
